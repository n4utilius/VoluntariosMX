 ...
 *
 *  IBM Mobile Cloud Services JavaScript SDK, v0.3.2
 *
 */
...
if(isNode) {
	...
	if(!xhrMod) {
		console.log("Could no load Node.js 'request' module")
	}
}
// Generated by IBMBaaS SDK v0.6.14 - template: 'combined' 
...
var __isAMD = !!(typeof define === 'function' && define.amd),
  ...
  var __nodeRequire = (__isNode ? require :
      function(dep){
        throw new Error("IBMBaaS SDK detected missing dependency: '" + dep + "' - in a non-nodejs runtime. All it's binding variables were 'undefined'.")
      });
...
define('request',[],function () {
  ...
  throw new Error("IBMBaaS SDK: trying to access unbound / excluded 'node-only' dependency 'request') on browser");
}
});
define('ibm/baas/lib/IBMQ', ['require','exports','module'],function (require, exports, module) {
...
define('ibm/baas/lib/IBMUnderscore', ['require','exports','module'],function (require, exports, module) {
  var __umodule__ = (function (require, exports, module) {
...
define('ibm/baas/lib/IBMAjax', ['require','exports','module'],function (require, exports, module) {
...
define('ibm/baas/IBMHttpRequest', ['require', 'exports', 'module', './lib/IBMUnderscore', './lib/IBMQ', './lib/IBMAjax'], function (require, exports, module, _, Q, jqXhr) {
  var __umodule__ = (function (require, exports, module, _, Q, jqXhr) {
...
function HttpRequestError(message, info) {
  ...
  function ErrorServerStatus(code, responseBody, info) {
    info = info || {};
    var err = {
        statusCode: code,
    ...
    _.extend(err, info);
    return HttpRequestError("Server responded with an error status", err);
  }
  function ErrorCommunicating(info) {
    info = info || {};
  ...
  var _HttpRequest = {
      ...
      _getValidOptions: function (options) {
        _.keys(options).forEach(function (key) {
          if (this.validOptions.indexOf(key) < 0) {
            console.warn("-> Removed option: " + key);
            delete options[key];
          }
        }.bind(this));
      ...
      _augmentHeaders: function (options) {
        var headers = options.headers = options.headers || {}, validContentTypes = this.contentTypeMap;
        ...
        function _augmentWithContext(headers) {
          ...
          var contexts = [
              ...
              },
              {
                ...
                value: config.oauth && config.oauth.token
              },
              {
                header: "IBM-OAuth-Token",
                value: config.oauth && config.oauth.token
              },
              {
                header: "IBM-Security-Provider",
                value: config.oauth && config.oauth.provider
              }
            ];
  ...
  function NodeHttpRequest() {
    var nodeRequestModule = require("request");
    if (!nodeRequestModule) {
      throw new TypeError("Unable to retrieve request module. Was 'npm install' called?");
    }
    function onFinish(handleAs, defer) {
      return function (err, res, body) {
        if (err) {
          ...
          if (res && res.statusCode < 400) {
            try {
              var toReturn = _HttpRequest.postProcessResponse(body, handleAs);
    ...
    return function (options) {
      var map = { "data": "body" };
      var requestOptions = _HttpRequest.createOptions(map, options), defer = Q.defer();
      if (requestOptions.contentType == "multipart") {
        console.warn("multipart request not yet supported for IBMHttpRequest in Node");
      }
      nodeRequestModule(requestOptions, onFinish(requestOptions["handleAs"], defer));
      return defer.promise;
    };
  }
  function BrowserHttpRequest() {
    var browserRequestModule = jqXhr;
    return function (options) {
      var map = {
          "method": "type",
          "handleAs": "dataType"
      ...
      requestOptions.error = function (jqXhr, textStatus, exception) {
        if (jqXhr.status > 0) {
      ...
      browserRequestModule.ajax(requestOptions);
      return defer.promise;
    };
  }
  var isNode = typeof __isNode === "boolean" ? __isNode : typeof exports === "object";
  var httpRequestFunction = isNode ? NodeHttpRequest() : BrowserHttpRequest();
  [
    "get",
    "post",
    "put",
    ...
    httpRequestFunction[method] = function (url, options) {
      options = options || {};
      options.url = url;
      if (method == "del") {
        method = "delete";
      ...
      return httpRequestFunction(options);
    };
  });
  return httpRequestFunction;


}).call(this, require, exports, module, _, Q, jqXhr);
...
define('ibm/baas/utils/IBMUriBuilder', ['require','exports','module'],function (require, exports, module) {
  var __umodule__ = (function (require, exports, module) {
...
define('ibm/baas/utils/IBMUtils', ['require', 'exports', 'module', '../lib/IBMUnderscore'], function (require, exports, module, _) {
...
define('ibm/baas/utils/IBMError', ['require', 'exports', 'module', '../lib/IBMUnderscore', './IBMUtils'], function (require, exports, module, _, utils) {
...
define('ibm/baas/core/IBMBaaSConfig', ['require','exports','module'],function (require, exports, module) {
  

"use strict";
  var DEFAULT_BAAS_URL = "https://mobile.ng.bluemix.net";
  var CLIENT_PLATFORM_TYPE = "JAVASCRIPT";
  function IBMBaaSConfig(applicationId) {
    if (!(this instanceof IBMBaaSConfig)) {
      throw new TypeError("IBMBaaSConfig constructor cannot be called as a function.");
    }
    if (!applicationId || _.isEmpty(applicationId)) {
      throw "initilizeSDK needs a valid Application ID.";
    }
    this.applicationId = applicationId;
    this.baasURL = DEFAULT_BAAS_URL;
  }
  ;
  IBMBaaSConfig.prototype = {
    baasURL: null,
    applicationId: null,
    clientId: null,
    deviceType: CLIENT_PLATFORM_TYPE,
    constructor: IBMBaaSConfig,
    getBaaSURL: function () {
      return this.baasURL;
    },
    ...
    setSecurityContext: function (oauth) {
      this.oauth = oauth;
    },
  ...
  return IBMBaaSConfig;


});
define('ibm/baas/core/IBMBaaSPluginManager', ['require', 'exports', 'module', '../lib/IBMQ'], function (require, exports, module, Q) {
  

"use strict";
  function IBMBaaSPluginManager(config) {
    if (!(this instanceof IBMBaaSPluginManager)) {
      throw new TypeError("IBMBaaSPluginManager constructor cannot be called as a function.");
    }
    if (!config || config === null) {
      throw "IBMBaaSPluginManager needs to be initialised with a IBMBaaSConfig object.";
    }
    this.config = config;
  }
  ;
  IBMBaaSPluginManager.prototype = {
    plugins: {},
    config: null,
    constructor: IBMBaaSPluginManager,
    getAllPluginsArray: function () {
      return this.plugins;
    },
    registerPlugins: function (plugins) {
      ...
      plugins.forEach(function (plugin) {
        if (!plugin.class) {
          throw "configuration is invalid, need a valid 'class' property to load plugin";
        }
        if (!this.getPluginById(plugin.id)) {
          var _plugins = this.plugins;
          this.instantiatePlugin(plugin, this).then(function (_instance) {
            _plugins[plugin.id] = _instance;
            if (typeof IBMBaaS === "object") {
              IBMBaaS[plugin.id] = _instance;
            }
            defer.resolve();
          }, function (err) {
            console.log(err);
          ...
          console.log(plugin.id + "," + plugin.class + " have already been registered with this ID");
        }
      }, this);
      return defer.promise;
    },
    instantiatePlugin: function (plugin, pluginManager) {
      var defer = Q.defer();
      if (!plugin.class) {
        throw "configuration is invalid, need a valid 'class' property to load plugin";
      }
      require([plugin["class"]], function (Plugin) {
        try {
          var _instance = new Plugin();
          _instance.initialize(pluginManager);
          defer.resolve(_instance);
        } catch (e) {
          defer.reject("failed to initialize plugin :" + plugin.id);
        }
      });
      return defer.promise;
    },
    ...
    getPluginsByClass: function (clazz) {
      return classPlugins;
    },
    getPluginByClass: function (clazz) {
      return classPlugins.get(0);
    }
  };
  return IBMBaaSPluginManager;


});
define('ibm/baas/IBMBaaS', ['require', 'exports', 'module', './lib/IBMQ', './lib/IBMUnderscore', './IBMHttpRequest', './utils/IBMUriBuilder', './utils/IBMUtils', './utils/IBMError', './core/IBMBaaSConfig', './core/IBMBaaSPluginManager'], function (require, exports, module, Q, _, httpRequest, uri, utils, error, IBMBaaSConfig, IBMBaaSPluginManager) {
  var __umodule__ = (function (require, exports, module, Q, _, httpRequest, uri, utils, error, IBMBaaSConfig, IBMBaaSPluginManager) {
...
var IBMBaaS = {
      ...
      config: null,
      pluginManager: null,
      initializeSDK: function (applicationId) {
        var defer = Q.defer();
        try {
          this.config = new IBMBaaSConfig(applicationId);
        } catch (e) {
          defer.reject("Invalid ApplicationId has been passed to the SDK");
        }
        try {
          this.pluginManager = new IBMBaaSPluginManager(this.config);
          defer.resolve(this.pluginManager);
        } catch (e) {
          defer.reject("PluginManager was not able to complete initialization error," + e);
        }
        return defer.promise;
      },
      getApplicationId: function () {
      ...
      getBaaSURL: function () {
        return this.config.getBaaSURL();
      },
      getVersion: function () {
        return this.VERSION;
      },
      getClientPlatformType: function () {
        return this.config.getClientPlatformType();
      },
      setApplicationId: function (applicationId) {
        this.config.setApplicationId(applicationId);
      },
      setBaaSURL: function (baasURL) {
        this.config.setBaaSURL(baasURL);
      },
      setSecurityContext: function (provider, token) {
        if (!_.isString(provider)) {
          throw new Error("Invalid provider property");
        }
        if (!_.isString(token)) {
        ...
        this.config.setSecurityContext(oauth);
      }
    };
  return IBMBaaS;


}).call(this, require, exports, module, Q, _, httpRequest, uri, utils, error, IBMBaaSConfig, IBMBaaSPluginManager);
var __old__ibmbaa_s0 = window['IBMBaaS'];
window['IBMBaaS'] = __umodule__;

__umodule__.noConflict = function () {
  window['IBMBaaS'] = __old__ibmbaa_s0;
return __umodule__;
};
return __umodule__;
});
    return require('ibm/baas/IBMBaaS');
  };
if (__isAMD) {
