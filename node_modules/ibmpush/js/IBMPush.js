...
// Generated by IBMPush SDK v0.6.14 - template: 'combined' 
...
define('ibm/baas/service/push/IBMPushService', ['require','exports','module'],function (require, exports, module) {
...
function IBMPushService() {
  ...
  IBMPushService.prototype = {
    ...
    createTag: function (tagName, description) {
      ...
      var defer = Q.defer();
      IBMHttpRequest.post(url, options).then(function (response) {
    ...
    updateTagDescription: function (tagName, description) {
      ...
      var defer = Q.defer();
      IBMHttpRequest.put(url, options).then(function (response) {
    ...
    getTags: function () {
      var defer = Q.defer();
      var url = new IBMUriBuilder(this.endpoint).append("tags").toString();
      IBMHttpRequest.get(url).then(function (response) {
    ...
    deleteTag: function (tagName) {
      var defer = Q.defer();
      var url = new IBMUriBuilder(this.endpoint).append("tags").slash().append(tagName).toString();
      IBMHttpRequest.del(url).then(function () {
...
define('ibm/baas/service/IBMPush', ['require', 'exports', 'module', './push/IBMPushService'], function (require, exports, module, IBMPushService) {
  var __umodule__ = (function (require, exports, module, IBMPushService) {
...
var IBMPush = {
      ...
      initializeService: function () {
        if (!(IBMBaaS && Q && _ && IBMHttpRequest)) {
          throw new IBMError("IBMBaaS or {Q,_,IBMHttpRequest} are undefined.");
        }
        this._push = new IBMPushService();
        if (!_.isObject(this._push)) {
          throw new IBMError("Failed to create a IBM Push service object");
        }
        return this._push;
      },
      getVersion: function () {
...
}).call(this, require, exports, module, IBMPushService);
...
return __umodule__;
    ...
    return require('ibm/baas/service/IBMPush');
  };
if (__isAMD) {
