...
// Generated by IBMData SDK v0.6.14 - template: 'combined' 
...
define('ibm/baas/utils', ['require','exports','module'],function (require, exports, module) {
...
define('ibm/baas/service/data/error/IBMError', ['require', 'exports', 'module', '../../../utils'], function (require, exports, module, utils) {
...
define('ibm/baas/service/data/error/IBMDataError', ['require', 'exports', 'module', './IBMError'], function (require, exports, module, IBMError) {
...
define('ibm/baas/service/data/comm/_DataServiceRequest', ['require', 'exports', 'module', '../error/IBMError'], function (require, exports, module, IBMError) {
...
var OPERATIONS = {
  ...
  function _DataServiceRequest(serviceUrl) {
    this.serviceUrl = serviceUrl;
  }
  _DataServiceRequest.OP = OPERATIONS;
  _DataServiceRequest.setRequester = function (instance) {
    this.requester = instance;
  };
  _DataServiceRequest.getRequester = function () {
    if (!this.requester) {
      throw new IBMError("Request class not set. SDK was likely not initialized.");
    }
    return this.requester;
  };
  _DataServiceRequest.prototype = {
    OP: _DataServiceRequest.OP,
...
define('ibm/baas/service/data/IBMObject', ['require', 'exports', 'module', '../../utils', './error/IBMDataError', './comm/_DataServiceRequest'], function (require, exports, module, utils, IBMDataError, _DataServiceRequest) {
  

var TAG = "IBMObject", OP = _DataServiceRequest.OP;
  ...
  IBMObject.prototype = {
    ...
    del: function () {
      return this._asyncOp(OP.DELETE);
    },
    read: function () {
      if (!this.getId()) {
        ...
        return Q.reject(invalidOperation(OP.READ, reason, this.isDeleted()));
      }
      return this._asyncOp(OP.READ);
    },
    ...
    _asyncOp: function (op) {
      ...
      return this.requester.send(this, op).then(this._onOpSuccess(op));
    },
  ...
  Object.defineProperties(IBMObject.prototype, {
    requester: {
      enumerable: false,
      get: function () {
        if (!this.__req) {
          this.__req = _DataServiceRequest.getRequester();
        }
        return this.__req;
      },
      set: function (val) {
...
define('ibm/baas/service/data/IBMQuery', ['require', 'exports', 'module', './IBMObject', '../../utils', './error/IBMDataError', './comm/_DataServiceRequest'], function (require, exports, module, IBMObject, utils, IBMDataError, _DataServiceRequest) {
  

var OP = _DataServiceRequest.OP;
  function generateIBMObject(serverVersion) {
    var obj = new IBMObject(serverVersion.className);
    obj._updateWithServerVersion(serverVersion);
    return obj;
  }
  function IBMQuery(className) {
    this.query = { className: className };
  }
  IBMQuery.prototype = {
    ...
    find: function (criteria, options) {
      ...
      return this._doQuery(this.query).then(function (queryResult) {
        var result = queryResult.map(generateIBMObject);
        return Q.resolve(result);
      });
    },
    _doQuery: function (query) {
      return this.requester.send(query, OP.QUERY);
    }
  };
  Object.defineProperties(IBMQuery.prototype, {
    requester: {
      enumerable: false,
      get: function () {
        if (!this.__req) {
...
define('ibm/baas/service/data/comm/RestRequest', ['require', 'exports', 'module', '../../../utils', './_DataServiceRequest', '../error/IBMError'], function (require, exports, module, utils, _DataServiceRequest, IBMError) {
...
var TAG = "RestRequest", timeout = 5000;
  ...
  utils.inherit(_DataServiceRequest, RestRequest, {
    ...
    _request: function (request) {
      ...
      this.bjax(xhrOptions).then(this._onRequestDone(defer).bind(this), this._onRequestDone(defer, true).bind(this));
    ...
    _queryRequest: function (query) {
      ...
      var req = {
          endpoint: "objects?" + utils.toQueryString(queryStr),
          method: "GET"
        };
...
define('ibm/baas/service/data/IBMDataService', ['require', 'exports', 'module', './IBMObject', './IBMQuery', './comm/_DataServiceRequest', './comm/RestRequest'], function (require, exports, module, IBMObject, IBMQuery, _DataServiceRequest, RestRequest) {
...
define('ibm/baas/service/IBMData', ['require', 'exports', 'module', './data/IBMDataService', './data/comm/_DataServiceRequest', './data/comm/RestRequest'], function (require, exports, module, IBMDataService, _DataServiceRequest, RestRequest) {
  var __umodule__ = (function (require, exports, module, IBMDataService, _DataServiceRequest, RestRequest) {
...
var IBMData = {
      ...
      initializeService: function () {
        if (!IBMBaaS && !Q && !IBMHttpRequest) {
          throw new Error("IBMBaaS,Q,IBMHttpReqest are undefined.");
        }
        var endpoint = new IBMUriBuilder(IBMBaaS.getBaaSURL()).append("data"), appId = IBMBaaS.getApplicationId(), rr = new RestRequest(endpoint, appId);
        _DataServiceRequest.setRequester(rr);
        this._data = IBMDataService;
        return this._data;
      },
      getVersion: function () {
        return this.VERSION;
...
}).call(this, require, exports, module, IBMDataService, _DataServiceRequest, RestRequest);
...
return __umodule__;
    ...
    return require('ibm/baas/service/IBMData');
  };
if (__isAMD) {
